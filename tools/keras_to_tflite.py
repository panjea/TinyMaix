...
def keras_to_tflite(h5_name, tflite_name, is_quant, quant_dir, norm_type = None, mean = 0.0, std = 0.0):
...
def print_usage():
	print("Usage: python3 keras_to_tflite.py keras_name tflite_name is_quant quant_dir norm_type")
...
if __name__ == '__main__':
	...
	keras_to_tflite(h5_name, tflite_name, is_quant, quant_dir, norm_type = norm_type)
